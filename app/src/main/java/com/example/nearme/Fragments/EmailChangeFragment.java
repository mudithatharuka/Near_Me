...
public class EmailChangeFragment extends Fragment {
    ...
    private com.example.nearme.databinding.FragmentEmailChangeBinding binding;
    private LoadingDialog loadingDialog;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = com.example.nearme.databinding.FragmentEmailChangeBinding.inflate(inflater, container, false);
