...
import com.example.nearme.Utility.LoadingDialog;
import com.example.nearme.databinding.FragmentEmailChangeBinding;
import com.example.nearme.databinding.FragmentEmailConfirmationBinding;
...
public class EmailConfirmationFragment extends Fragment {
    ...
    private EmailConfirmationFragmentArgs emailConfirmationFragmentArgs;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        emailConfirmationFragmentArgs = EmailConfirmationFragmentArgs.fromBundle(requireArguments());
        isPassword = emailConfirmationFragmentArgs.getIsPassword();
    ...
    private boolean areFieldReady(){
        ...
        password = binding.edtCEmail.getText().toString().trim();
        email = binding.edtCPassword.getText().toString().trim();
