...
import com.example.nearme.Permissions.AppPermissions;
import com.example.nearme.R;
import com.example.nearme.Utility.LoadingDialog;
import com.example.nearme.databinding.FragmentSettingsBinding;
            ...
            firebaseAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(getContext(), "Email was sent verify the email.", Toast.LENGTH_SHORT).show();
                    }else{
