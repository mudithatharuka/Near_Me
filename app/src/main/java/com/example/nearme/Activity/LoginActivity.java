...
import com.example.nearme.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.txtFogetPassword.setOnClickListener(view->{
            startActivity(new Intent(LoginActivity.this, FogetActivity.class));
        });
